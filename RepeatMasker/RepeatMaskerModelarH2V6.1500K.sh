...
cd /g/data/xf3/zz3507/Output/AfterHiCProcessing/AnnotationV2/RepeatMasker/H2V6.sorted
RepeatMasker -pa 24 -e rmblast -gff -xsmall -lib /g/data/xf3/zz3507/Output/AfterHiCProcessing/AnnotationV2/RepeatModeler/H2V6.sorted/122385118.gadi-pbs/H2V6.First22.FINAL.sorted-families.fa \
